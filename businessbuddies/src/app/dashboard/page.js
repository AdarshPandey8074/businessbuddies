                ...
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
                        <div className="w-full sm:p-4 px-4 mb-6">
                            ...
                            <h1 className="title-font font-medium text-xl mb-2 text-gray-900">Welcome to your Business Bingo Dashboard!</h1>
                            ...
                            <ul className="list-disc list-inside"> {/* Tailwind classes for list */}
                                ...
                                {correctmatch.map((user, index) => (
                                    <li key={index} className="mb-2">
                                        ...
                                        <a href='https://wa.me/8074398138' target='_blank'>
